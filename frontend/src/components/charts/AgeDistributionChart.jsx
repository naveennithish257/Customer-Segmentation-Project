...
const CustomTooltip = ({ active, payload, label }) => {
  ...
  return (
    <div className="custom-tooltip">
      ...
      <div>Count: <b style={{ color: '#1e293b' }}>{payload[0].value?.toLocaleString()}</b></div>
    </div>
  )
}

const COLORS = ['#00d4ff','#22d3ee','#38bdf8','#60a5fa','#818cf8','#a78bfa','#c084fc']
  ...
  return (
    <ResponsiveContainer width="100%" height={260}>
      <BarChart data={data} margin={{ top: 5, right: 10, left: -10, bottom: 0 }}>
        ...
        <XAxis dataKey="age_group" tick={{ fill: '#475569', fontSize: 11 }} axisLine={false} tickLine={false} />
